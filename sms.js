...
var sendSmsDismissal = function() {
    var dismissal = {
        ...
        'package_name': pb.e2e.optEncrypt('sms'),
        'notification_id': pb.e2e.optEncrypt(0)
    };
...
pb.getThreads = function(deviceIden, callback) {
    if (!pb.threads[deviceIden]) {
        ...
        pb.post(pb.api + '/v3/get-permanent', body, function(response) {
            pb.threads[deviceIden] = utils.decryptIfNeeded(response);
...
pb.getThread = function(deviceIden, threadId, callback) {
    ...
    if (pb.thread[body.key]) {
        ...
        pb.post(pb.api + '/v3/get-permanent', body, function(response) {
            response = utils.decryptIfNeeded(response);
            if (response) {
                response.thread.reverse();
            }

            pb.thread[body.key] = response;
            callback(pb.thread[body.key]);
        });
    }
};
...
var processSmsQueue = function() {
    ...
    var real = {
        ...
        'guid': sms.guid,
        'package_name': pb.e2e.optEncrypt('com.pushbullet.android'),
        'conversation_iden': pb.e2e.optEncrypt(sms.address),
        'message': pb.e2e.optEncrypt(sms.body)
    };
